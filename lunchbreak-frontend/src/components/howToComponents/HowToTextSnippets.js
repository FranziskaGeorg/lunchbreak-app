...
export function HowToSteps() {
    ...
    return (
        <Typography>
            <div className={classes.highlightedText}>STEP 1: Profil ausfüllen</div>
            <p>
            ...
            <div className={classes.highlightedText}>STEP 2: Matches finden</div>
            <p>
            ...
            <div className={classes.highlightedText}>STEP 3: Lunchen!</div>
            <p>
...
export function Imprint() {
    ...
    return (
        <Typography>
            <div className={classes.highlightedText}>Angaben gemäß § 5 TMG</div><br/>
            Franziska Georg<br/>
            Corkstraße 18<br/>
            51103 Köln
            <br/><br/>
            <div className={classes.highlightedText}>Vertreten durch:</div>
            Franziska Georg
            <br/><br/>
            <div className={classes.highlightedText}>Kontakt:</div>
            franzi.georg@web.de
            <br/><br/>
            <div className={classes.highlightedText}>Haftungsausschluss:</div><br/>
            <div className={classes.highlightedText}>Haftung für Inhalte</div>
            ...
            <br/><br/>
            <div className={classes.highlightedText}>Urheberrecht</div>
            ...
            <br/><br/>
            <div className={classes.highlightedText}>Datenschutz</div>
